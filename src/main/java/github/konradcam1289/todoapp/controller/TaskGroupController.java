...
import github.konradcam1289.todoapp.adapter.SqlTaskRepository;
import github.konradcam1289.todoapp.logic.TaskGroupService;
...
public class TaskGroupController {
    ...
    TaskGroupController(final TaskGroupService service, final TaskRepository repository, SqlTaskRepository taskRepository) {
    ...
    ResponseEntity<List<Task>> readAllTasksFromGroup(@PathVariable int id) {
        return ResponseEntity.ok(taskRepository.findAllByGroup_IdOrderByDeadlineAsc(id));
    }
