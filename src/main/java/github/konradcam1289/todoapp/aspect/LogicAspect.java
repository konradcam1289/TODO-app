package github.konradcam1289.todoapp.aspect;
...
class LogicAspect {
    ...
    public LogicAspect(final MeterRegistry registry) {
        projectCreateGroupTimer = registry
                .timer("logic.project.create.group");
    }
    @Before("execution(* github.konradcam1289.todoapp.logic.ProjectService.createGroup(..))")
    ...
    @Around("execution(* github.konradcam1289.todoapp.logic.ProjectService.createGroup(..))")
